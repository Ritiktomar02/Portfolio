...
export const About = () => {
  const frontendSkills = ["ReactJS", "Redux Toolkit", "TailwindCSS"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                ...
                <li>CGPA: 9.0/10 (5th Sem)</li>
                <li>
                  <a
                    href="https://drive.google.com/file/d/1n_xoyrvia3F1uyxLL2pzeMdg49kW5h7o/view?usp=sharing"
                    target="_blank"
                  ...
                  |{" "}
                  <a
                    href="https://github.com/Ritiktomar02"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-400 hover:underline"
                  >
                  ...
                  |{" "}
                  <a
                    href="https://www.linkedin.com/in/ritiktomar02/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-400 hover:underline"
                  >
                  ...
                  |{" "}
                  <a
                    href="https://leetcode.com/u/ritikmsd7/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-400 hover:underline"
                  >
